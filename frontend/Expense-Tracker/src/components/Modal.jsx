...
const Modal = ({ children, isOpen, onClose, title }) => {
  ...
  return <div className="fixed top-0 right-0 left-0 z-50 flex justify-center items-center w-full h-[calc(100%-1rem)] max-h-full overflow-y-auto overflow-x-hidden  bg-opacity-50 bg-black/40 backdrop-blur-sm
">
